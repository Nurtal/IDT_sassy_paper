...
5th--95th percentile over $N\!=\!20$ replicates):}
...
published test suite (68 tests); sub-capabilities flagged as deferred
...
\textbf{Test suite.} Validation is structured as 68 automated tests
(pytest): 23 ODE adapter tests, 20 ABM adapter tests, 8 blood transit
transfer model tests, and 17 integration tests. All tests are
...
All 68 automated tests pass. The Miao 2010 adapter initialises
...
test suite (68 adapter + 51 paper--data tests) are at
